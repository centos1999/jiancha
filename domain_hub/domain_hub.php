...
请及时续期，避免域名失效。",
        ...
        "telegram_group_welcome_enabled" => [
            "FriendlyName" => "启用 Telegram 入群自动欢迎",
            "Type" => "yesno",
            "Default" => "no",
            "Description" => "开启后，Bot 检测到新成员加入群组时自动发送欢迎引导消息",
        ],
        "telegram_group_welcome_chat_ids" => [
            "FriendlyName" => "入群欢迎允许群ID",
            "Type" => "textarea",
            "Rows" => "3",
            "Cols" => "60",
            "Description" => "可选。填写允许触发入群欢迎的群 Chat ID，多个用逗号/换行分隔；留空表示允许所有群组",
        ],
        "telegram_group_welcome_template" => [
            "FriendlyName" => "入群欢迎消息模板",
            "Type" => "textarea",
            "Rows" => "4",
            "Cols" => "60",
            "Default" => "欢迎 {username} 加入本群！绑定Bot请在客户中心网页点击对应链接进行绑定。",
            "Description" => "支持变量：{username}（优先 @用户名，其次显示名，再次 Telegram ID）",
        ],
        "telegram_group_welcome_cooldown_seconds" => [
            "FriendlyName" => "入群欢迎冷却秒数",
            "Type" => "text",
            "Size" => "6",
            "Default" => "30",
            "Description" => "同一群组欢迎消息冷却时间（建议 10-300 秒）",
        ],
        "enable_ssl_request" => [
